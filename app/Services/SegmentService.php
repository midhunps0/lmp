...
class SegmentService implements ModelViewConnector {
    ...
    public function getCreatePageData(): CreatePageData
    {
        return new CreatePageData(
            ...
            form: FormHelper::makeForm(
                title: 'Create Segment',
                id: 'form_segments_create',
                action_route: 'segments.store',
                success_redirect_route: 'segments.index',
    ...
    public function buildCreateFormLayout(): array
    {
         ...
         $layout = (new ColumnLayout())
            ->addElements([
                    (new RowLayout())
                        ->addElements([
                            (new ColumnLayout(width: '1/2'))->addInputSlot('segments'),
