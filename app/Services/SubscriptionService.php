...
class SubscriptionService implements ModelViewConnector {
    ...
    public function getCreatePageData(): CreatePageData
    {
        return new CreatePageData(
            ...
            form: FormHelper::makeForm(
                title: 'Create Subscription',
                id: 'form_subscriptions_create',
                action_route: 'subscriptions.store',
                success_redirect_route: 'subscriptions.index',
    ...
    public function getEditPageData($id): EditPageData
    {
        return new EditPageData(
            ...
            form: FormHelper::makeEditForm(
                title: 'Edit Subscription',
                id: 'form_subscriptions_create',
                action_route: 'subscriptions.update',
